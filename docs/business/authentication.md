...
| Поле 2 | **Пароль** |
| CTA | **Войти** (доступна после согласия с Terms) |
| Ссылки | «Забыли пароль?» · «Создать аккаунт» |
| Соцкнопки | Google · Apple (iOS) — тоже только после согласия |
| Согласие | Чекбокс: Terms + Privacy (обязательно до входа / регистрации) — [ugc-safety.md](ugc-safety.md) |
