...
import { AdminSupportInbox } from "@/features/admin/components/admin-support-inbox";
    ...
    <main className="mx-auto flex min-h-dvh w-full max-w-2xl flex-col gap-6 px-5 py-10">
      <header className="flex flex-wrap items-center justify-between gap-3">
        <div>
          ...
          <h1 className="mt-1 text-[24px] font-bold tracking-tight text-ink">Support</h1>
          <p className="mt-1 text-[13px] text-muted">Заявки с формы /support</p>
        </div>
        <Link
          href="/admin/home"
