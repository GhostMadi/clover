...
export default function PrivacyPage() {
  return (
    <LegalPage title="Политика конфиденциальности" updated="26 сентября 2026">
      ...
      <LegalSection title="6. Срок хранения">
        <p>
          Данные хранятся, пока нужен ваш аккаунт и сервис. После безвозвратного удаления аккаунта (запрос через{" "}
          <Link className="text-brand underline underline-offset-2" href="/delete-account">
            /delete-account
          </Link>
          ) персональные данные удаляются или обезличиваются в разумный срок, кроме случаев, когда закон или
          безопасность требуют иное (например, расследование злоупотреблений). Деактивация в приложении скрывает
          профиль, но не стирает данные каскадом.
        </p>
      </LegalSection>
