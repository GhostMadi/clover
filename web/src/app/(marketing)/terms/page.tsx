...
export default function TermsPage() {
  return (
    <LegalPage title="Условия использования" updated="24 сентября 2026">
      <LegalSection title="1. Принятие условий">
        <p>
          ...
          . В приложении согласие запрашивается до регистрации и входа.
        </p>
      </LegalSection>
      ...
      <LegalSection title="4. Контент пользователей и нулевая терпимость">
        <p>
          Вы сохраняете права на свой контент и даёте Clover лицензию на его показ в рамках сервиса.
        </p>
        <p>
          <strong>Нулевая терпимость</strong> к неприемлемому контенту и оскорбительному поведению: незаконный контент,
          ненависть, травля, угрозы, сексуальная эксплуатация, спам, вредоносные действия и нарушение прав других
          людей запрещены. Нарушители могут быть лишены доступа без предупреждения.
        </p>
        <p>
          Пользователи могут <strong>пожаловаться</strong> на контент или профиль и <strong>заблокировать</strong>{" "}
          автора (контент сразу исчезает из их ленты). Блок и жалоба уведомляют команду Clover. Мы рассматриваем
          обращения и принимаем меры (удаление контента и/или ограничение аккаунта){" "}
          <strong>в течение 24 часов</strong>.
        </p>
      </LegalSection>
      ...
      <LegalSection title="7. Прекращение">
        <p>
          ...
          нарушении условий или требований закона, в том числе по результатам жалоб на UGC.
        </p>
      </LegalSection>
