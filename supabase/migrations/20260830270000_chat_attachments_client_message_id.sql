-- Reconcile optimistic attachment sends via client_message_id (same as send_message).

set search_path = public;

drop function if exists public.send_message_with_attachments(uuid, text, text, uuid, jsonb);
