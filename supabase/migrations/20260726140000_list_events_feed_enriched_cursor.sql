-- Events discovery feed: enriched post cards with marker filters (Events tab).
...
comment on function public.list_events_feed_enriched_cursor(jsonb) is
  'Events tab discovery feed: enriched posts with marker filters and keyset pagination.';
