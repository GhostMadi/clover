...
| `20260801140000_profiles_with_sync_meta_refresh_bonus.sql` | 0 | Historical: recreated view after `bonus_program_status` (view dropped in `20260830120000_drop_sync_meta.sql`) |
