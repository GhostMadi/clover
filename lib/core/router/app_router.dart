  ...
  List<AutoRoute> get routes => [
    AutoRoute(
      ...
      children: [
        ...
        AutoRoute(page: BookingListDetailRoute.page),
        ...
        AutoRoute(page: SettingsWorkRoute.page),
        AutoRoute(page: EmployerWorkRoute.page),
        AutoRoute(page: WorkerWorkRoute.page),
