            ...
            child: BackdropFilter(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  color: colors.bottomBarColor.withValues(alpha: 0.95),
                  borderRadius: BorderRadius.circular(32),
                  border: Border.all(color: colors.bottomBarActiveIcon.withValues(alpha: 0.2), width: 1.5),
                  boxShadow: [
                    BoxShadow(
                      ...
                      children: [
                        ...
                        if (message != null && message.isNotEmpty) ...[
                          Padding(
                            ...
                            child: Text(
                              message,
                              style: AppTextStyle.base(15, color: colors.subTextColor, height: 1.45),
                            ),
                          ),
                        ],
                              ...
                              Expanded(
                                child: FilledButton(
                                  ...
                                  style: FilledButton.styleFrom(
                                    backgroundColor: confirmIsDestructive ? colors.error : colors.primary,
