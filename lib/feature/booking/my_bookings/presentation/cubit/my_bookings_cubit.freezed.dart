...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function( BookingListDateRange period)?  loading,TResult Function( BookingListDateRange period,  List<MyBookingItem> items)?  loaded,TResult Function( BookingListDateRange period,  String message)?  error,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case _Loading() when loading != null:
return loading(_that.period);case _Loaded() when loaded != null:
return loaded(_that.period,_that.items);case _Error() when error != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function( BookingListDateRange period)  loading,required TResult Function( BookingListDateRange period,  List<MyBookingItem> items)  loaded,required TResult Function( BookingListDateRange period,  String message)  error,}) {final _that = this;
switch (_that) {
case _Initial():
return initial();case _Loading():
return loading(_that.period);case _Loaded():
return loaded(_that.period,_that.items);case _Error():
return error(_that.period,_that.message);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function( BookingListDateRange period)?  loading,TResult? Function( BookingListDateRange period,  List<MyBookingItem> items)?  loaded,TResult? Function( BookingListDateRange period,  String message)?  error,}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case _Loading() when loading != null:
return loading(_that.period);case _Loaded() when loaded != null:
...
class _Loaded implements MyBookingsState {
  const _Loaded({required this.period, required final  List<MyBookingItem> items}): _items = items;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Loaded&&(identical(other.period, period) || other.period == period)&&const DeepCollectionEquality().equals(other._items, _items));
}


@override
int get hashCode => Object.hash(runtimeType,period,const DeepCollectionEquality().hash(_items));

@override
String toString() {
  return 'MyBookingsState.loaded(period: $period, items: $items)';
}
...
@useResult
$Res call({
 BookingListDateRange period, List<MyBookingItem> items
});
