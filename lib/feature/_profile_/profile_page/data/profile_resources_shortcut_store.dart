...
/// Показывать ли на профиле быструю кнопку «Ресурсы» (настройка в Сервисы → Ресурсы).
@lazySingleton
class ProfileResourcesShortcutStore {
  ProfileResourcesShortcutStore(this._storage);

  final IAppStorage _storage;

  final ValueNotifier<bool> visible = ValueNotifier(false);

  static String _key(String userId) => 'resource_profile_resources_shortcut_$userId';
