...
enum MarkerTagKey {
  ...
  feedback('feedback', 'Отзывы на витрине', MarkerTagGroupKey.admin),
  ...
  AppServiceKind? get serviceKind => switch (this) {
    MarkerTagKey.booking || MarkerTagKey.bookingCalendar || MarkerTagKey.feedback =>
      AppServiceKind.booking,
