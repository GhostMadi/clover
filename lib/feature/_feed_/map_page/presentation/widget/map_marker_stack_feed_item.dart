...
class MapMarkerStackFeedItem extends StatelessWidget {
  const MapMarkerStackFeedItem({super.key, required this.item});
...
class _DetailsSection extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return BlocBuilder<MapMarkerStackFeedCubit, MapMarkerStackFeedState>(
  ...
  PostFeedItem? _findItem(MapMarkerStackFeedState state, String postId) {
    if (state is! MapMarkerStackFeedLoaded) return null;
...
class _PostMediaSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<MapMarkerStackFeedCubit, MapMarkerStackFeedState>(
      ...
      builder: (context, state) {
        final cubit = context.read<MapMarkerStackFeedCubit>();
        final feedItem = _findItem(state, item.post.id) ?? item;
          ...
          child: Row(
            ...
            children: [
              ...
              if (label != null) ...[
                ...
                Text(
                  label!,
                  style: AppTextStyle.base(13, color: color, fontWeight: FontWeight.w600),
                ),
              ],
            ],
          ),
