...
class _BookingServiceEditPageState extends State<BookingServiceEditPage> {
  ...
  Future<void> _addExecutor() async {
    ...
    setState(() {
      _draft = _draft.copyWith(executors: [..._draft.executors, BookingExecutorPick.fromStaff(staff)]);
    });
  }
  ...
  Future<void> _submit() async {
    ...
    AppSnackBar.show(context, message: context.l10n.booking_service_saved, kind: AppSnackBarKind.success);
      ...
      child: BlocBuilder<BookingServiceEditorCubit, BookingServiceEditorState>(
        ...
        builder: (context, state) {
          ...
          return BookingScreenShell(
            title: context.l10n.booking_service_edit_title,
            compactBar: true,
