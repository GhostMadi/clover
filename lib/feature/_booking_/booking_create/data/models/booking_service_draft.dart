...
class BookingServiceDraft {
  ...
  bool get isValid {
    ...
    if (bonusPayPercent < 0 || bonusPayPercent > 100) return false;
    if (bonusEarnAmount < 0) return false;
  ...
  factory BookingServiceDraft.fromService(BookingService service) {
    return BookingServiceDraft(
      ...
      bonusPayPercent: service.bonusPayPercent,
      bonusEarnAmount: service.bonusEarnAmount,
    );
  }
