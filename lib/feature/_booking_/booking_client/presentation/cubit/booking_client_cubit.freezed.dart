...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function( String hostId,  String hostDisplayName)?  loading,TResult Function( String hostId,  String hostDisplayName,  List<BookingServiceWithStaff> catalog,  BookingScheduleSettings schedule,  DateTime selectedDay,  BookingService? selectedService,  BookingServiceExecutor? selectedExecutor,  DateTime? selectedSlotStart,  List<ClientBookingSlot> slots,  String? dayUnavailableReason,  String? conflictMessage,  bool isLoadingSlots,  bool isSubmitting,  bool useBonuses,  int bonusBalanceAtHost)?  ready,TResult Function( String hostId,  String hostDisplayName,  String message)?  error,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case _Loading() when loading != null:
return loading(_that.hostId,_that.hostDisplayName);case _Ready() when ready != null:
return ready(_that.hostId,_that.hostDisplayName,_that.catalog,_that.schedule,_that.selectedDay,_that.selectedService,_that.selectedExecutor,_that.selectedSlotStart,_that.slots,_that.dayUnavailableReason,_that.conflictMessage,_that.isLoadingSlots,_that.isSubmitting,_that.useBonuses,_that.bonusBalanceAtHost);case _Error() when error != null:
...
@JsonKey() final  bool useBonuses;
@JsonKey() final  int bonusBalanceAtHost;
...
as bool,bonusBalanceAtHost: null == bonusBalanceAtHost ? _self.bonusBalanceAtHost : bonusBalanceAtHost // ignore: cast_nullable_to_non_nullable
as int,
  ));
}
