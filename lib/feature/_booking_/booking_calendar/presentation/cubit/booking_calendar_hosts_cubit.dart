...
class BookingCalendarHostsCubit extends Cubit<BookingCalendarHostsState> {
  ...
  Future<void> _syncRemote() async {
    try {
      ...
      emit(BookingCalendarHostsState.error(message: BookingException.from(e).message ?? lookupAppLocalizations(sl<AppLocaleCubit>().state.locale).booking_load_failed));
    }
  }
}
