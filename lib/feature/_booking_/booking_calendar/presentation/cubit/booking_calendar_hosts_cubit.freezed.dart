...
part of 'booking_calendar_hosts_cubit.dart';
...
/// @nodoc
mixin _$BookingCalendarHostsState {
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is BookingCalendarHostsState);
}
...
@override
String toString() {
  return 'BookingCalendarHostsState()';
}
...
/// @nodoc
class $BookingCalendarHostsStateCopyWith<$Res>  {
$BookingCalendarHostsStateCopyWith(BookingCalendarHostsState _, $Res Function(BookingCalendarHostsState) __);
}


/// Adds pattern-matching-related methods to [BookingCalendarHostsState].
extension BookingCalendarHostsStatePatterns on BookingCalendarHostsState {
...
class _Initial implements BookingCalendarHostsState {
  const _Initial();
...
@override
String toString() {
  return 'BookingCalendarHostsState.initial()';
}
...
class _Loading implements BookingCalendarHostsState {
  const _Loading();
...
@override
String toString() {
  return 'BookingCalendarHostsState.loading()';
}
...
class _Loaded implements BookingCalendarHostsState {
 ...
 List<BookingCalendarHost> get hosts {
...
/// @nodoc
abstract mixin class _$LoadedCopyWith<$Res> implements $BookingCalendarHostsStateCopyWith<$Res> {
...
class _Error implements BookingCalendarHostsState {
...
@override
String toString() {
  return 'BookingCalendarHostsState.error(message: $message)';
}
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $BookingCalendarHostsStateCopyWith<$Res> {
